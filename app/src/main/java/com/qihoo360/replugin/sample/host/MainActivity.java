...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btn_start_demo4).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // 示例：直接通过宿主打开WebView插件中的Activityl
        ...
        findViewById(R.id.btn_mytest).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = RePlugin.createIntent("com.qihoo360.replugin.sample.demo1", "com.qihoo360.replugin.sample.demo1.service.PluginDemoService1");
               ...
               /* Intent intent = new Intent(
                ...
                RePlugin.startActivity(MainActivity.this, intent, "demo2", null);*/

            }
        });

        File dir = getDir("mm_nn", 0);
        String sss = dir.getAbsolutePath();
